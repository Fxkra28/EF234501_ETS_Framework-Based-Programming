            ...
            @forelse($this->cart as $cartItem)
                <div class="flex items-center justify-between p-4 mb-4 bg-gray-50 dark:bg-neutral-700 rounded-xl shadow-sm">
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">IDR {{ number_format($cartItem['price'], 2) }} each</p>
                    </div>
            ...
            <div class="mt-6 pt-6 border-t border-gray-200 dark:border-neutral-700">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="font-medium text-gray-800 dark:text-gray-100">
                        IDR {{ number_format($this->subtotal, 2) }}
                    </span>
                </div>

                <div class="flex justify-between items-center mb-2">
                    <span class="text-sm text-gray-600 dark:text-gray-400">Pajak (11%):</span>
                    <span class="font-medium text-gray-800 dark:text-gray-100">
                        IDR {{ number_format($this->tax, 2) }}
                    </span>
                </div>

                <div class="flex justify-between items-center text-lg font-semibold mt-2 border-t border-gray-200 dark:border-neutral-700 pt-2">
                    <span>Total Akhir:</span>
                    <span>IDR {{ number_format($this->total, 2) }}</span>
                </div>

                <div class="flex justify-between items-center text-lg font-semibold mt-2 border-t border-gray-200 dark:border-neutral-700 pt-2">
                    <span>Kembalian:</span>
                    <span>IDR {{ number_format($this->change, 2) }}</span>
                </div>
            </div>
